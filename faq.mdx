...
CamelQA does not retain any data from your app and does not allow OpenAI to retain any of your data. We work by taking a screenshot of your app, sending that screenshot to our servers and using AI to generate the code to complete the next step. 

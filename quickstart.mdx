  ...
  <Tab title="Android">
    ...
    <Steps>
      ...
      <Step title="Enable QUERY_ALL_PACKAGES">
        ...
        This step is required to allow camelQA to switch between apps. **If you do not need to swtich between apps, you may skip this step.**
        ...
        ```xml
          ...
          ...
        ```
        <Note>This will raise a warning related to the use of the QUERY_ALL_PACKAGES permission. Ignore the warning.</Note>


        **Alternatively,** if you would like to switch between apps without allowing all apps, you can add a `<queries>` element within the `<manifest>` element of your `AndroidManifest.xml` file. 
          ...
          ```java Groovy/Java
            ...
            public class ExampleInstrumentedTest {
              ...
              public void myFirstTest() {
                ...
                q.execute("tap the search bar at the bottom")
                q.execute("type Youtube")
                q.execute("tap Youtube app")

...
**Work Arounds:** Check the [icon type list](docs.camelqa.com/trouble-shooting/icon-list). If your icon is not listed, request it be added in our [#icon-list-request discord channel](https://discord.com/invite/juNYATfJTZ)
